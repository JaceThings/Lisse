...
This is used internally by `@lisse/react`, `@lisse/vue`, `@lisse/svelte`, and `@lisse/octane` to make existing CSS borders and shadows "just work" without manual conversion. If you're using the core package directly, you can use these functions to implement the same behaviour:
